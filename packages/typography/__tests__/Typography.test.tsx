...
describe('with props.noMargin', () => {
  ...
  it('renders paragraph with no margin-bottom', () => {
    ...
    expect(screen.getByText(children)).toHaveStyle('margin: 0')
    expect(screen.getByText(children)).not.toHaveStyle('margin-bottom: 0.8rem')
  })
})

describe('with props.variant', () => {
  it.each<Required<TypographyProps>['variant']>([
    'p',
    'p1',
    'p2',
    'p3',
    ...
    'h5',
    'h6',
  ])('renders p with variant=%j', (variant) => {
